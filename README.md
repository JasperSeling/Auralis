> ⚠️ Это форк оригинального [astramind-ai/Auralis](https://github.com/astramind-ai/Auralis).
> Оригинал не поддерживается с декабря 2024. Этот форк содержит следующие исправления:
> - ✅ Фикс event loop (работает в Jupyter/Colab)
> - ✅ Исправлены зависимости (нет конфликтов torch/torchaudio)
> - ✅ Исправлен change_speed()
> - ✅ Добавлен Colab quickstart notebook
